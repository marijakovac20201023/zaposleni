                        ...
                        <div className="card-heading"></div>
                            <div className="card-body">
                                ...
                                <form onSubmit={handleRegister}>
                                    ...
                                    <div className="input-group">
                                        <input className="input--style-3" type="text" placeholder="Plata  [€]" name="plata "required onInput={handleInput}/>
                                    </div>
                                    <div className="input-group">
                                      <select  className="input--style-3" name="kvalifikacijaID" id="kvalifikacijaID"    onInput={handleInput}>
